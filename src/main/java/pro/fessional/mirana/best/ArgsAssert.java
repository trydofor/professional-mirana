...
public class ArgsAssert {
    ...
    public static void isNull(Object b, @NotNull String msg, @NotNull Object... args) {
        if (b != null) throw new IllegalArgumentException(FormatUtil.format(msg, args));
    }
    ...
    public static <T extends Comparable<T>> void aEqb(T a, T b, @NotNull String msg, @NotNull Object... args) {
        ...
        if (a == null || !a.equals(b)) throw new IllegalArgumentException(FormatUtil.format(msg, args));
    }
    ...
    public static <T extends Comparable<T>> void aGeb(T a, T b, @NotNull String msg, @NotNull Object... args) {
        if (a == null && b == null) return;
        if (a == null || b == null || a.compareTo(b) < 0) throw new IllegalArgumentException(FormatUtil.format(msg, args));
    }
