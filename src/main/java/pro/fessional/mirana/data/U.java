...
public class U {
    ...
    public static <T1, T2, T3, T4, T5> Five<T1, T2, T3, T4, T5> of(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5) {
        return new Five<>(t1, t2, t3, t4, t5);
    }

    public static <T1, T2, T3, T4, T5, T6> Six<T1, T2, T3, T4, T5, T6> of(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) {
        return new Six<>(t1, t2, t3, t4, t5, t6);
    }

    public static <T1, T2, T3, T4, T5, T6, T7> Seven<T1, T2, T3, T4, T5, T6, T7> of(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7) {
        return new Seven<>(t1, t2, t3, t4, t5, t6, t7);
    }

    public static <T1, T2, T3, T4, T5, T6, T7, T8> Eight<T1, T2, T3, T4, T5, T6, T7, T8> of(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8) {
        return new Eight<>(t1, t2, t3, t4, t5, t6, t7, t8);
    }

    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9> Nine<T1, T2, T3, T4, T5, T6, T7, T8, T9> of(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9) {
    ...
    public static class Six<T1, T2, T3, T4, T5, T6> {
        private final T1 t1;
        private final T2 t2;
        private final T3 t3;
        private final T4 t4;
    ...
    public static class Seven<T1, T2, T3, T4, T5, T6, T7> {
        private final T1 t1;
        private final T2 t2;
        private final T3 t3;
        private final T4 t4;
    ...
    public static class Eight<T1, T2, T3, T4, T5, T6, T7, T8> {
        private final T1 t1;
        private final T2 t2;
        private final T3 t3;
        private final T4 t4;
    ...
    public static class Nine<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
        private final T1 t1;
        private final T2 t2;
        private final T3 t3;
        private final T4 t4;
