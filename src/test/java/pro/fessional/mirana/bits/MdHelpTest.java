...
class MdHelpTest {
    ...
    void print() {
        ...
        Testing.println("Md5    Hex=" + md5Sum);
        Testing.println("Sha1   Hex=" + sha1Sum);
        Testing.println("Sha256 Hex=" + sha256Sum);
        ...
        Testing.println("Md5    B64=" + Base64.encode(MdHelp.md5.digest(bytes)));
        Testing.println("Sha1   B64=" + Base64.encode(MdHelp.sha1.digest(bytes)));
        Testing.println("Sha256 B64=" + Base64.encode(MdHelp.sha256.digest(bytes)));
    }
